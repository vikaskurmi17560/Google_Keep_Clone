...
function Sidebar() {
  return (
   <aside className='w-[100%] shadow-[0_3px_10px_rgb(0,0,0,0.2)] bg-gray-800 text-white p-4 flex flex-col gap-5 top-14 left-0 h-[calc(100vh-56px)]'>
    <div className='flex w-[100%] gap-5 justify-center items-center p-3 '>
